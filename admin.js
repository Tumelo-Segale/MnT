...
function updateDashboardStats() {
    ...
    const lastResetYear = localStorage.getItem('lastResetYear') || currentYear;
    if (currentYear > parseInt(lastResetYear)) {
...
function downloadStatement() {
    ...
    csvContent += `${currentYear},${yearlyOrders.length},${yearlyStats.revenue},${yearlyStats.profit}\n\n`;
